...
public:
    ...
    void createCameraEntity() {
        Entity camera = getScene()
                            .createEntity("camera")
                            .add<TransformComponent>(glm::vec3{0.0f, -0.0f, -3.25f}, glm::vec3{0.0f, 0.0f, 0.0f},
                                                     glm::vec3{0.0f, 0.0f, 0.0f})
                            .add<CameraComponent>();

        camera.addAndGet<ScriptComponent>().bind<CameraController>();

        getScene().setActiveCameraEntity(camera.getUID());
    }

    Entity createPointLightEntity(const float intensity = 1.0f, const float radius = 0.1f,
                                  const glm::vec3 color = glm::vec3(1.f)) {
        Entity entity = getScene()
                            .createEntity("point_light")
                            .add<PointLightComponent>(intensity)
                            .add<TransformComponent>(glm::vec3{0.f, 0.f, 0.f}, glm::vec3{radius, 1.f, 1.f},
                                                     glm::vec3{0.0f, 0.0f, 0.0f})
    ...
    void createFloor() {
        ...
        Entity entity = getScene()
                            ...
                            .add<TransformComponent>(glm::vec3{0.f, 1.0f, 0.f}, glm::vec3{1.f, 1.f, 1.f},
                                                     glm::vec3{0.0f, 0.0f, 0.0f})
                            .add<MeshComponent>(AssetHandle{quad->id})
    ...
    void createTeapotAndVases() {
        ...
        Entity entity = getScene()
                            ...
                            .add<MeshComponent>(AssetHandle{vaseMesh->id});
        entity
            .addAndGet<MaterialComponent>(
                MaterialComponent::Builder().setMaterial(AssetHandle{glassMaterial->id}).build())
            .tint =
        ...
        entity = getScene()
                     ...
                     .add<MeshComponent>(AssetHandle{teapotMesh->id});
        entity
            .addAndGet<MaterialComponent>(
                MaterialComponent::Builder().setMaterial(AssetHandle{metallicMaterial->id}).build())
        ...
        entity.addAndGet<MaterialComponent>(MaterialComponent::Builder()
                                                .setMaterial(AssetHandle{glassMaterial->id})
        ...
        Entity entity =
            getScene()
                ...
                .add<TransformComponent>(glm::vec3{-0.75f, 0.9f, -0.3f}, glm::vec3{0.1f, 0.1f, 0.1f},
                            ...
                            .add<MeshComponent>(AssetHandle{rubikMesh->id})
                            .add<MaterialComponent>(
                                MaterialComponent::Builder().setMaterial(AssetHandle{rubikMaterial->id}).build());
    }
    ...
    void createLamp() {
        ...
        Entity entity = getScene()
                            ...
                            .add<MeshComponent>(AssetHandle{lampMesh->id})
                            .add<MaterialComponent>(
                                MaterialComponent::Builder().setMaterial(AssetHandle{lampMaterial->id}).build());
    }
        ...
        Entity entity =
            getScene()
                ...
                .add<TransformComponent>(glm::vec3{0.0f, -1.1f, 0.0f}, glm::vec3{0.25f, 0.25f, 0.25f},
                            ...
                            .add<MeshComponent>(AssetHandle{roofLightMesh->id})
                            .add<MaterialComponent>(
                                MaterialComponent::Builder().setMaterial(AssetHandle{roofLightMaterial->id}).build());
    }
        ...
        Entity entity =
            getScene()
                ...
                .add<TransformComponent>(glm::vec3{0.65f, 0.985f, -0.1f}, glm::vec3{0.1f, 0.1f, 0.1f},
                            ...
                            .add<MeshComponent>(AssetHandle{pencilMesh->id})
                            .add<MaterialComponent>(
                                MaterialComponent::Builder().setMaterial(AssetHandle{pencilMaterial->id}).build());
    ...
    void loadScene() override {
        ...
        /*auto volumeCubeEntity = getScene().createEntity("Volume Cube")
            ...
            .add<MeshComponent>(AssetHandle{cubeModel)
        ...
        auto emissiveSphere =
            getScene()
                ...
                .add<MeshComponent>(AssetHandle{sphereModel->id})
                .add<MaterialComponent>(MaterialComponent::Builder().setMaterial(AssetHandle{emissiveMat->id}).build());
        ...
        /*Entity entity = getScene().createEntity("glass cube")
           ...
           / 4, 0.0f }) .add<MeshComponent>(AssetHandle{cubeModel) .add<MaterialComponent>(MaterialComponent::Builder()
        ...
        Entity entity =
            getScene()
                ...
                .add<MeshComponent>(AssetHandle{bunny->id})
                .add<VolumeComponent>(VolumeComponent::Builder()
