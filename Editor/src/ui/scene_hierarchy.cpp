...
namespace pxt::editor {
    ...
    void SceneHierarchy::drawSceneEntityList(Scene& scene, core::UID& selectedEntityId,
        ...
        for (auto entityHandle : view) {
            ...
            constexpr const char* eyeIconTooltip = "Hides this entity in the editor viewport";
            ...
            constexpr const char* renderableIconTooltip = "Hides this entity in the final render";
