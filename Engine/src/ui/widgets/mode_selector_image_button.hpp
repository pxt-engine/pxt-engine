...
namespace pxt::ui {
    ...
    /*
     * @brief Renders a floating button on top of the current window.
     */
    class ModeSelectorImageButton {
    public:
        template <typename T>
        static bool render(ImTextureID texture, const char* strId, const char* tooltip, const T& value, T& currentValue,
                           const ImVec2& size, const ImVec4& activeColor = ImVec4(0.25f, 0.45f, 0.85f, 0.90f),
                           ...
                           const ImVec4& inactiveColor = ImVec4(0.15f, 0.15f, 0.15f, 0.60f),
                           const ImVec4& inactiveHovered = ImVec4(0.25f, 0.25f, 0.25f, 0.80f),
                           const ImVec4& inactivePressed = ImVec4(0.20f, 0.20f, 0.20f, 0.90f)) {
