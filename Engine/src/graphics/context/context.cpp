...
namespace pxt {
    ...
    Context::Context(Window& window)
        : m_window(window), m_instance{"PXT Engine"}, m_surface{m_window, m_instance},
          m_physicalDevice{m_instance, m_surface}, m_device{m_window, m_instance, m_surface, m_physicalDevice} {
    ...
    bool Context::supportsAnisotropy() { return m_physicalDevice.properties.limits.maxSamplerAnisotropy > 1.0f; }

    float Context::getMaxSamplerAnisotropy() { return m_physicalDevice.properties.limits.maxSamplerAnisotropy; }
    ...
    void Context::createShaderModuleFromSourceBinary(const std::vector<uint32_t>& binary,
    ...
    bool Context::getSupportedDepthFormat(VkFormat* depthFormat) {
        ...
        std::vector<VkFormat> formatList = {VK_FORMAT_D32_SFLOAT_S8_UINT, VK_FORMAT_D32_SFLOAT,
