...
namespace pxt {
    ...
    public:
        CompositionRenderSystem(Context& context, DescriptorAllocatorGrowable& descriptorAllocator);
        ...
        void render(FrameInfo& frameInfo, VulkanImage& sceneColor, VulkanImage& objectIdImage, VulkanImage& outputImage,
