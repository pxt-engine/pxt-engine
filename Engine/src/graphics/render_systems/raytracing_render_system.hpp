...
namespace pxt {
    ...
    private:
        ...
        uint32_t m_blueNoiseTextureIndeces[BLUE_NOISE_TEXTURE_COUNT]; // Indices of the blue noise textures in the
                                                                      // texture registry
        uint32_t m_blueNoiseDebugIndex = 0;                           // Index of the blue noise texture to use
        VkBool32 m_selectSingleBlueNoiseTextures =
            VK_FALSE; // Whether to select single textures or use different blue noise textures every frame
