...
namespace pxt {
    ...
    void VulkanImage::transitionImageLayoutSingleTimeCmd(VkImageLayout newLayout, VkPipelineStageFlags sourceStage,
        ...
        barrier.srcQueueFamilyIndex =
            VK_QUEUE_FAMILY_IGNORED; // If you are using the barrier to transfer queue family ownership, then these two
                                     // fields should be the indices of the queue families.
        barrier.dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED; // They must be set to VK_QUEUE_FAMILY_IGNORED if you
                                                               // don't want to do this (not the default value!).
