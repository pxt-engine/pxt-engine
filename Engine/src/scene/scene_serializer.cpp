    ...
    bool SceneSerializer::deserialize(const std::string& filepath) {
        ...
        for (auto entityNode : entities) {
            ...
            if (auto transformComponentNode = entityNode["TransformComponent"]) {
                ...
                entity.add<TransformComponent>(glm::vec3(translation[0], translation[1], translation[2]),
            ...
            if (auto transform2dComponentNode = entityNode["Transform2dComponent"]) {
                ...
                entity.add<Transform2dComponent>(glm::vec2(translation[0], translation[1]),
