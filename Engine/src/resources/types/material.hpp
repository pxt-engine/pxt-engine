...
namespace pxt {
    ...
    public:
        ...
        Material(const glm::vec4& albedoColor, const Shared<Image>& albedoMap, const Shared<Image>& normalMap,
                 ...
                 const float ior, const float blinnPhongSpecularIntensity, const float blinnPhongSpecularShininess);
