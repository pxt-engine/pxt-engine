...
namespace pxt {
    ...
    Unique<Image> TextureImporter::import(const std::filesystem::path& filePath, ResourceInfo* resourceInfo) {
    ...
    Unique<Texture2D> TextureImporter::importTexture2D(const std::filesystem::path& filePath,
